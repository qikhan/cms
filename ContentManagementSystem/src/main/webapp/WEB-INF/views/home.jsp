    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p>Manage your content and publish them at ease. Enable targeted content push. Enable e-commerce on any content.</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <h2>Create an Reader Account</h2>
          <p>Open the door to explore limitless content of all kind. Receive exclusive offers and access to content of your interest.</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
       </div>
      </div>
